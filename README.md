...
1) In Arduino go to File -> Preferences add these URLs [http://arduino.esp8266.com/stable/package_esp8266com_index.json](http://arduino.esp8266.com/stable/package_esp8266com_index.json),[https://github.com/cristianonescu/Arduino/releases/download/2.4.0/package_deauther_index.json](https://github.com/cristianonescu/Arduino/releases/download/2.4.0/package_deauther_index.json) at *Additional Boards Manager URLs*
